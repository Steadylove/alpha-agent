...
import { runRotate, type RotateOpts, type RotateResult } from "@/lib/fund/rotate";

/**
 * 现金账本网格入口。引擎在 `src/lib/fund/rotate.ts`。
 *
 *   npx --yes tsx scripts/fund-rotate.ts <1d|4h|2h|1h> <part> [costBps]
 */

type Mode = RotateOpts["mode"];
export type Opts = RotateOpts;
type Result = RotateResult;

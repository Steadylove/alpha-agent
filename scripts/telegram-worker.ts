...
const config: { token?: string; relaySecret?: string; identityPrivateKey?: string; mode?: "polling" | "webhook"; webhookSecret?: string } = existsSync(configFile) ? (await import(pathToFileURL(configFile).href)).default : {};
